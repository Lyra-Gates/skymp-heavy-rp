...
> **Status Atual (Ativo, 11/08/2026):** a fundação técnica possui 547 testes de gamemode aprovados, mas ainda não foi homologada com jogadores reais. Governance, Market Stalls, Painel do Jogador, morte com consequência, soft-delete, Afinidade da Alma e VOIP estão implementados atrás de flags de laboratório. A fronteira CEF agora tem gateway, validação e rate limiting; o ciclo de conexão invalida respostas assíncronas antigas; credenciais opacas têm contrato central; e economia/tesouros ganharam transações, ledger e idempotência nas migrations v11–v13. A Economia Regional continua **PARKED**: suas fronteiras estão seguras e testadas, mas o módulo não é registrado no boot. O próximo gate continua sendo a sessão real da Fase 0.
