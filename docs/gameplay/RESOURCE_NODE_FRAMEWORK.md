...
|---|---|
| `resource_nodes` + `resource_node_gathers` (migration v27): capacidade, regen, gate, cooldown e replay | Nó ligado a um objeto real no mundo com interação de jogador |
...
`migration-v27-resource-nodes.sql` e falha se alguma coluna usada pelo
serviço sumir de lá.
