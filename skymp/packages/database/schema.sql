...
CREATE TABLE IF NOT EXISTS `characters` (
  ...
  `pos_x` FLOAT NOT NULL DEFAULT 22659.0,
  `pos_y` FLOAT NOT NULL DEFAULT -8697.0,
  `pos_z` FLOAT NOT NULL DEFAULT -3594.0,
  `angle_z` FLOAT NOT NULL DEFAULT 268.0,
  `cell_id` VARCHAR(64) NOT NULL DEFAULT '1a26f:Skyrim.esm',
...
-- 4.1. Demandes de recréation d'un personnage persistant SkyMP
...
-- 4.2. Identités connues du personnage
...
-- 4.3. Inventario Persistente do Personagem
...
CREATE TABLE IF NOT EXISTS `prison_records` (
  ...
  `cell_id` VARCHAR(64) NOT NULL DEFAULT '1a26f:Skyrim.esm' COMMENT 'Celula da prisao',
