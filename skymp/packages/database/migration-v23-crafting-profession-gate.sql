-- v23 — crafting_recipes: gate de profissão/rank
--
-- Implementado originalmente como v20 na branch `feat/crafting-profession-integration`
-- (20/08/2026), órfã desde então. `main` já tinha v20 (Depot) e v21/v22
-- (Crime/Proveniência) quando este trabalho foi trazido em 22/08/2026 — só a
-- numeração mudou (v20 -> v23) para não colidir; conteúdo idêntico.
--
-- ═══════════════════════════════════════════════════════════════════════════
